    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_salvar)
                .setOnClickListener(v -> {
                    ...
                    // SUPERVISOR SOMENTE VISUAL

                    String supervisorAtual =
