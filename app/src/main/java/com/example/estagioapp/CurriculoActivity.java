...
public class CurriculoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEnviar.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(telefone)) {
                etTelefone.setError("Obrigatório");
            ...
            FirebaseHelper.refCandidaturas()
                    ...
                    .addOnSuccessListener(snapshot -> {
                        ...
                        for (DataSnapshot snap : snapshot.getChildren()) {
                            ...
                            String vidSnap =
                                    snap.child("vagaId").getValue(String.class);
    ...
    private void enviarCandidatura(String uid,
                                   String nome,
                                   String email,
                                   String telefone,
                                   String pretensao,
        ...
        // Busca o UID da empresa dona da vaga
        FirebaseHelper.refVagas()
                ...
                .addOnSuccessListener(snapshot -> {
                    ...
                    // Salva junto na candidatura
                    candidatura.put("empresaUid", empresaUid);
                                ...
                                if (vagaId != null) {
                                    ...
                                    FirebaseHelper.refVagas()
                                            ...
                                            .addOnSuccessListener(snap -> {
                                                ...
                                                Long atual =
                                                        snap.getValue(Long.class);

                                                long novo =
                                                        (atual != null ? atual : 0) + 1;
                ...
                .addOnFailureListener(e -> {
                    ...
                    Toast.makeText(this,
                            "Erro ao buscar empresa da vaga.",
                            Toast.LENGTH_LONG).show();
                });
    }
